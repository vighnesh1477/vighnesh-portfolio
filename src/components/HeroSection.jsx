...
import { FaGithub, FaLinkedinIn, FaInstagram, FaDownload, FaArrowRight } from 'react-icons/fa';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    <p className="text-lg text-gray-600 dark:text-gray-400 mt-5 mb-8 max-w-lg font-body">
                        An 18-year-old Engineering student and an aspiring developer from Udupi, India, passionate about building beautiful and animated user interfaces.
                    </p>
                    ...
                    <div className="flex items-center space-x-6">
                        <span className="font-body font-medium text-gray-900 dark:text-gray-50 border-r pr-6 border-gray-300 dark:border-gray-700 hidden sm:block">Follow Me</span>
